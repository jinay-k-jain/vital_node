...
columns_to_keep = ['AGE', 'PULSE', 'RESPR', 'POPCT', 'BPSYS', 'TEMPF', 'IMMEDR']
...
df = df.rename(columns={'AGE': 'age', 'PULSE': 'hr', 'RESPR': 'rr', 'POPCT': 'spo2', 'BPSYS': 'sys_bp'})
...
X = df[['age', 'hr', 'rr', 'spo2', 'sys_bp', 'temp', 'symptom_risk', 'history_available', 'missing_vitals_count']]
y = df['acuity']
